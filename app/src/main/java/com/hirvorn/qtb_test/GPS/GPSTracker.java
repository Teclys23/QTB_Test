package com.hirvorn.qtb_test.GPS;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            ...
            if (ActivityCompat.checkSelfPermission(Principale.getController().getContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                // TODO: Consider calling
                //    ActivityCompat#requestPermissions
                // here to request the missing permissions, and then overriding
                //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
    ...
    public void showSettingsAlert(){
        ...
        // Setting Dialog Title
        alertDialog.setTitle("Setting del GPS");

        // Setting Dialog Message
        alertDialog.setMessage("Il GPS non è abilitato. Vuoi andare alle impostazioni?");
